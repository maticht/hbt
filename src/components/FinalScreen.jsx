        ...
        <div className="main">
            <div className={'finale-text-block'}>
                ...
                <p className={'textText'}>Моя милая прекрасная леди, с днем рождения! <br></br>
                    ...
                    <br></br>
                    И в следующим году желаю тебе преисполниться, быть гордой собой и превзойти ожидания 21 однолетней
                    себя!
                    <br></br>
                    Удачи тебе в постижении английского и дизайна.
                    Желаю тебе как можно быстрее найти крутую работу!
                    А так же пусть следующей год запомниться тебе ещё и активным, счастливым и спокойным отдыхом и
                    кучей встреч с Мотькой
                    <br></br>
                    Люблю тебя!
                    <br></br>
